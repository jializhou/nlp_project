...
def get_args():
    ...
    parser.add_argument('--train_file',
                        type=str,
                        default='../wdw_script/who_did_what/Strict/train.txt',
                        help='Training file')

    parser.add_argument('--dev_file',
                        type=str,
                        default='../wdw_script/who_did_what/Strict/val.txt',
    ...
    parser.add_argument('--model_file',
                        type=str,
                        default='../wdw_script/who_did_what/Res/model'+time+'.pkl.gz',
                        help='Model file to save')

    parser.add_argument('--log_file',
                        type=str,
                        default='../wdw_script/who_did_what/Res/log'+time+'.txt',
                        help='Log file')

    parser.add_argument('--embedding_file',
                        type=str,
                        default='../wdw_script/glove.6B/glove.6B.100d.txt',
