...
parser.add_argument('--babi_id', type=str, default="train.xml", help='babi task ID')
...
parser.add_argument('--babi_test_id', type=str, default="test.xml", help='babi_id of test set (leave empty to use --babi_id)')
